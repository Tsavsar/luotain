...
// Placeholder home page — meant to be swapped for a real marketing
// page later. For now: reuses the existing auth-page shell and the
// tagline already written for get-started, so this cost almost
// nothing to build and gives the root domain something real instead
// of the default Next.js starter page.
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className='para-sm' style={{ color: 'var(--text-sub)' }}>
              Already have an account?{' '}
              <span style={{ color: 'var(--primary-base)' }}>Log in</span>
            </span>
          </button>
        </div>
      </div>
